export const LANGUAGE_LIST_ROUTE = '/admin/languages'
export const LANGUAGE_CREATE_ROUTE = '/admin/languages'
export const LANGUAGE_EDIT_ROUTE = '/admin/languages'
export const LANGUAGE_SHOW_ROUTE = '/admin/languages'
export const LANGUAGE_DELETE_ROUTE = '/admin/languages'


export const STATIC_CONTENT_LIST_ROUTE = '/admin/static_contents'
export const STATIC_CONTENT_CREATE_ROUTE = '/admin/static_contents'
export const STATIC_CONTENT_EDIT_ROUTE = '/admin/static_contents'
export const STATIC_CONTENT_SHOW_ROUTE = '/admin/static_contents'
export const STATIC_CONTENT_DELETE_ROUTE = '/admin/static_contents'


export const POST_LIST_ROUTE = '/admin/posts'
export const POST_CREATE_ROUTE = '/admin/posts'
export const POST_EDIT_ROUTE = '/admin/posts'
export const POST_SHOW_ROUTE = '/admin/posts'
...
export const WIDGET_SHOW_ROUTE = '/admin/widgets'
export const WIDGET_DELETE_ROUTE = '/admin/widgets'


export const DATA_TYPE_LIST_ROUTE = '/admin/data_types'
export const DATA_TYPE_CREATE_ROUTE = '/admin/data_types'
export const DATA_TYPE_EDIT_ROUTE = '/admin/data_types'
export const DATA_TYPE_SHOW_ROUTE = '/admin/data_types'
...
export const MENU_TYPE_SHOW_ROUTE = '/admin/menu_types'
export const MENU_TYPE_DELETE_ROUTE = '/admin/menu_types'


export const MENU_ITEM_SAVE_ROUTE = '/admin/menu_items/save'
