...
import {LANGUAGE_EDIT_ROUTE, LANGUAGE_SHOW_ROUTE} from "@/admin/configs/apiRoutes";
...
export default function Index(props) {
    ...
    function handleSubmit(e) {
        ...
        if (Object.keys(errors).length > 0) {
            ...
            ApiService.put(`${LANGUAGE_EDIT_ROUTE}/${language_id}`, data).then(resp => {
                router.push({
    ...
    useEffect(() => {
        ApiService.get(`${LANGUAGE_SHOW_ROUTE}/${language_id}`).then(resp => {
